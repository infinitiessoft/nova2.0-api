...
import com.infinities.keystonemiddleware.model.ServiceCatalog;
...
public class AccessInfoV3 extends AccessInfo {
	...
	private com.infinities.keystonemiddleware.model.v3.Token token;
	private String authToken;
	private final static String version = "v3";


	public AccessInfoV3(String tokenid, com.infinities.keystonemiddleware.model.v3.Token token) {
		// super();
	...
	public List<String> getRoleIds() {
		...
		List<com.infinities.keystonemiddleware.model.v3.Token.Role> roles = token.getRoles();
		for (com.infinities.keystonemiddleware.model.v3.Token.Role role : roles) {
			ids.add(role.getId());
		}

 ...
 *
 */
public class SecurityGroupRuleTemplate implements Serializable {
	...
	private Rule securityGroupRule;


	/**
	 * @return the securityGroupRule
	 */
	public Rule getSecurityGroupRule() {
	 ...
	 */
	public void setSecurityGroupRule(Rule securityGroupRule) {

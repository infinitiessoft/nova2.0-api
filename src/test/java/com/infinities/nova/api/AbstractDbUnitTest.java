...
public class AbstractDbUnitTest {
	...
	public static void initEntityManager() throws HibernateException, DatabaseUnitException {
		entityManagerFactory = Persistence.createEntityManagerFactory("com.infinities.skyport.nova.jpa.test");
		entityManager = entityManagerFactory.createEntityManager();
		// connection = new DatabaseConnection(((SessionImpl)
		// (entityManager.getDelegate())).connection());
